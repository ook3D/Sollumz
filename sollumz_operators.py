...
def ynd_menu_func_import(self, context):
    from .ynd.operators import SOLLUMZ_OT_import_ynd
    self.layout.operator(SOLLUMZ_OT_import_ynd.bl_idname,
                         text=f"Node Dictionary ({YND.file_extension})")
...
def register():
    ...
    bpy.types.TOPBAR_MT_file_import.append(ynd_menu_func_import)
    bpy.types.TOPBAR_MT_file_export.append(sollumz_menu_func_export)


def unregister():
    bpy.types.TOPBAR_MT_file_import.remove(ynd_menu_func_import)
